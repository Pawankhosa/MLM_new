<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="KYC.aspx.cs" Inherits="Admin_Default2" %>
...
<table class="my-table" width="95%">
    <tr>
    	<td height="20px">
        <asp:GridView ID="GridView2" runat="server" CssClass="my-grid" CaptionAlign="Top" HorizontalAlign="Center" Width="900px">
        </asp:GridView>
        </td>
    </tr>
    <tr>
        <td class="my-table-header" align="center" style="font-size:20px">
           KYC List <a href="KYC1.aspx">(DONE)</a>    
        </td>
    </tr>
    <tr>
    	<td height="20px">
            ...
            <td align="center" width="150x" class="client_home_rw">Leader ID</td>
            <td align="center" width="150x">
...
<asp:Panel id="pnlContents" runat = "server">
        <asp:GridView ID="GridView1" runat="server" CssClass="my-grid"
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Update" CssClass="gray">KYC OK</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <SelectedRowStyle
