<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="KYC1.aspx.cs" Inherits="Admin_Default2" %>
    ...
    <tr>
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="my-grid"
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Update" CssClass="gray">OK</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
            <SelectedRowStyle
