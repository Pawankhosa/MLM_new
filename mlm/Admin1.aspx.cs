...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select sr from admin1 where sr=@ID";
        ...
        else
        {
            ...
            cmd1.CommandText = "select pass from admin1 where sr=@ID";
            ...
            {
                Session["admin1"] = Convert.ToString(TextBox1.Text.ToUpper());
                Response.Redirect("admin1");
            }
        }
        con.Dispose();
    }
